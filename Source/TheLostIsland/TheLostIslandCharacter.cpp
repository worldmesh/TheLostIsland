...
void ATheLostIslandCharacter::ClearCurrentInteractable()
{
	CurrentInteractable = nullptr;
...
void ATheLostIslandCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ATheLostIslandCharacter::Look);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATheLostIslandCharacter::Look);

		// Interact
		EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Started, this, &ATheLostIslandCharacter::Interact);
	}
	else
	{
		UE_LOG(LogTheLostIsland, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}
...
void ATheLostIslandCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ATheLostIslandCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ATheLostIslandCharacter::DoJumpEnd()
{
